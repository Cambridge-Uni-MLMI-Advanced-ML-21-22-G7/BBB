...
def make_model_diagrams(probabilities, predictions, confidences, labels, n_bins=10):
    """
    ...
    fig, ax = plt.figure(0, figsize=(8, 8))
    ...
    plt.legend([confs], ['Accuracy'], loc='upper left', fontsize='x-large')
